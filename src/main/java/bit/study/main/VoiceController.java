...
public class VoiceController {
	...
	public String sendVoice(String msg, String lang, HttpServletRequest request) {
		...
		String clientId = "p6q5npl8jj";//애플리케이션 클라이언트 아이디값";
        String clientSecret = "2MbtSFHDvXxTk4KewaDbcvh5veF9x1NQMVTJc1EL";//애플리케이션 클라이언트 시크릿값";
        try {
            ...
            if(responseCode==200) { // 정상 호출
                ...
                File f = new File(path+"/"+tempname + ".mp3"); // webapp에 mp3 파일로 저장
                f.createNewFile();
